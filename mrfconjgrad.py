...
def icmGauss(sigma2, img, kappa, itrns=100):
    """Perform iterated conditional mode for Gaussian prior
    ...
    Returns
    -------
    ximg : float numpy.ndarray
        Bayesian image analysis iterated conditional modes reconstructed image with GMRF prior.
